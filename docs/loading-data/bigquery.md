...
=== "Python"
    ...
    <img class="screenshot" src="../../screenshots/bigquery-dca.png">
    ...
    <img class="screenshot" src="../../screenshots/bigquery-dca-menu.png">

    Under the drop-down list of data sources you will find the BigQuery data source which we created earlier. Select it.

    <img class="screenshot" src="../../screenshots/bigquery-dca-data-sources.png">
    ...
    <img class="screenshot" src="../../screenshots/bigquery-dca-project-dataset-table.png">
