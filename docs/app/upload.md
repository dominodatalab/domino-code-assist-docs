...
Create a histogram using the Low Code Assistant™, as described in [Scatter Plot](../visualization/scatter.md) or add your own code. In our example we add the following code ourselves:
